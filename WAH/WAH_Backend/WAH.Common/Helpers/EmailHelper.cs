...
namespace WAH.Common.Helpers
{
    public static class EmailHelper
    {
        public static async Task SendOtpAsync(string email, string otp)
        {
            ...
            message.From.Add(new MailboxAddress("OtpAuthApi", "fardinl.itpath@gmail.com"));
            ...
            await client.AuthenticateAsync("fardinl.itpath@gmail.com", "przk uaxa xplj iezd");
        ...
        public static async Task SendUserEmailAsync(string toEmail, string subject, string body)
        {
            ...
            email.From.Add(new MailboxAddress("Reset Password:", "fardinl.itpath@gmail.com"));  
